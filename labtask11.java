...
class StudentForm extends JFrame implements ActionListener{
    ...
    ImageIcon image=new ImageIcon("mehran.png");
    ...
    public StudentForm(){   //Constructor
        ...
        setSize(500, 500);          //Jframe settings
    ...
    void Insert(){      //Method to insert details to Database
        ...
        String Query="Insert into stu_details Values ('"+Name.getText()+"','"+RollNO.getText()+"','"+Batch.getText()+"','"+Gender+"','"+Section.getText()+"','"+Qualification+"','"+Address.getText()+"','"+Countries[Country.getSelectedIndex()]+"');";
    ...
    void Fetch(){       //Method to Fetch data from Database
        ...
        String Query="Select * From stu_details where std_Name = '" + Name.getText() + "' AND RollNo = '" + RollNO.getText() + "' AND Batch = '" + Batch.getText() + "' AND Gender = '" + Gender + "' AND Section = '" + Section.getText() + "' AND Qualification = '" + Qualification + "' AND Address = '" + Address.getText() + "' AND Country = '" + Countries[Country.getSelectedIndex()] + "'";
        ...
        try {
            ...
            while(rs.next()) {
                ...
                P2.setBackground(Color.LIGHT_GRAY);  //JPanel Settings
